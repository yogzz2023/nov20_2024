...
class KalmanFilterGUI(QWidget):
    ...
    def initUI(self):
        ...
        # Add sub-tabs for plot types within the plot tab
        self.plot_type_tabs = QTabWidget()
        self.plot_tab.layout().addWidget(self.plot_type_tabs)
        ...
        # Add plot widgets to sub-tabs within a QGroupBox
        self.search_plot_group = QGroupBox("Search Plot")
        self.search_plot_layout.addWidget(self.search_plot_group)
        self.search_plot_group_layout = QVBoxLayout()
        self.search_plot_group.setLayout(self.search_plot_group_layout)
        self.search_plot_widget = pg.GraphicsLayoutWidget()
        self.search_plot_group_layout.addWidget(self.search_plot_widget)

        self.track_plot_group = QGroupBox("Track Plot")
        self.track_plot_layout.addWidget(self.track_plot_group)
        self.track_plot_group_layout = QVBoxLayout()
        self.track_plot_group.setLayout(self.track_plot_group_layout)
        self.track_plot_widget = pg.GraphicsLayoutWidget()
        self.track_plot_group_layout.addWidget(self.track_plot_widget)
        ...
        control_layout.addWidget(self.marker_size_label)
    ...
    def plot_measurements(self, tracks, plot, plot_type, selected_track_ids=None):
        for track in tracks:
            ...
            if plot_type == "Range vs Time":
                plot.plot(times, measurements_x, pen=None, symbol='o', symbolSize=marker_size, name=f'Track {track["track_id"]} Measurement X')
                plot.plot(Sf_times, Sf_x, pen='r', symbol=None, name=f'Track {track["track_id"]} Sf X')
                plot.setLabel('left', 'X Coordinate')
            elif plot_type == "Azimuth vs Time":
                plot.plot(times, measurements_y, pen=None, symbol='o', symbolSize=marker_size, name=f'Track {track["track_id"]} Measurement Y')
                plot.plot(Sf_times, Sf_y, pen='r', symbol=None, name=f'Track {track["track_id"]} Sf Y')
                plot.setLabel('left', 'Y Coordinate')
            elif plot_type == "Elevation vs Time":
                plot.plot(times, measurements_z, pen=None, symbol='o', symbolSize=marker_size, name=f'Track {track["track_id"]} Measurement Z')
    ...
    def show_subplots(self):
        ...
        for track in self.tracks:
            ...
            plot_x.plot(times, measurements_x, pen=None, symbol='o', symbolSize=marker_size, name=f'Track {track["track_id"]} Measurement X')
            plot_y.plot(times, measurements_y, pen=None, symbol='o', symbolSize=marker_size, name=f'Track {track["track_id"]} Measurement Y')
            plot_z.plot(times, measurements_z, pen=None, symbol='o', symbolSize=marker_size, name=f'Track {track["track_id"]} Measurement Z')
